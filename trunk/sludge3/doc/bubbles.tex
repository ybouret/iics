...
$$
We can define and \textbf{Order 1 Horizontal Leaving Pressure} $P^{L_1}$ by
$$
...
\item We can write
$$
	P_{i-1} = P_i - \delta_x \sigma^E_i + \dfrac{1}{2} \delta_x^2 \partial_x^2 P_i
$$
and
$$
	P_\phi = P_i + \phi \sigma^E_i + \dfrac{1}{2} \phi^2 \partial_x^2 P_i
$$
